...
### Banking Automation Framework (`alpine-bank-automation/`)
Production-ready automation solutions for banking operations:
- **alpine-bank-automation/compliance-automation**: Regulatory compliance and KYC/AML workflows
- **alpine-bank-automation/it-automation**: IT operations and infrastructure management
- **alpine-bank-automation/accounting-automation**: Financial operations and reconciliation
- **alpine-bank-automation/hr-automation**: Human resources process automation
