...
This repository contains multi-agent AI automation projects using the crewAI framework. It includes both training examples and production-ready banking automation frameworks.
...
Learning examples located in the `training/` directory. Each subdirectory is a standalone Jupyter notebook-based project:
...
Each training project directory contains:
...
### Banking Automation Framework (`alpine-automation/`)
Production-ready automation solutions for banking operations:
- **alpine-automation/compliance-automation**: Regulatory compliance and KYC/AML workflows
- **alpine-automation/information-technology-automation**: IT operations and infrastructure management
- **alpine-automation/accounting-automation**: Financial operations and reconciliation
- **alpine-automation/human-resources-automation**: Human resources process automation

Each subdirectory is designed for enterprise banking automation projects using multi-agent systems.
