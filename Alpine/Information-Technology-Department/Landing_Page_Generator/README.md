# AI Crew for Banking Product Landing Pages
## Introduction
This project uses the CrewAI framework to automate the creation of compliant landing pages for banking products and services. CrewAI orchestrates autonomous AI agents to create professional, regulatory-compliant landing pages for credit cards, loans, accounts, and other financial products.
...
## CrewAI Framework
CrewAI is designed to facilitate the collaboration of role-playing AI agents. In this example, these agents work together to transform banking product ideas into fully compliant landing pages by analyzing requirements, selecting appropriate templates, and customizing them with regulatory disclosures and banking-appropriate content.
...
- **Execute the Script**: Run `poetry run python main.py` and input your banking product idea.

## Details & Explanation
- **Running the Script**: Execute `python main.py`` and input your banking product when prompted (e.g., "High-yield savings account", "Business credit card", "Home mortgage"). The script will leverage the CrewAI framework to generate a compliant landing page with appropriate disclosures.
